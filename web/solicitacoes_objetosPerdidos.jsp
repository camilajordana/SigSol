                    ...
                    <table border="0" width="100%">
                        <tr>
                            <td  colspan="4" align="center">
                                <h2 id="a1">Solicitações de objetos perdidos</h2>
                            </td>
                                            ...
                                            <c:forEach var="registroObjetos" items="${sessaoListaObjetos}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="3%">
                                                        ...
                                                        <input type="hidden" name="id_solicitacaoObjeto" value="${registroObjetos['id_solicitacaoObjeto']}"> 

                                                        <a href="GM?acao=aceitarObjeto&id_solicitacaoObjeto=${registroObjetos['id_solicitacaoObjeto']}"><img src="imagens/feito.png" width="20" height="20" alt="deletar"/></a></td>
                                                    <td width="3%">   <a href="GM?acao=naoaceitoObjeto&id_solicitacaoObjeto=${registroObjetos['id_solicitacaoObjeto']}"><img src="imagens/naofeito.png" width="20" height="20" alt="deletar"/></a></td>
                            ...
                            <tr>
                                <td>
                                    <div align="right"> 
                                        <br>
                                        <p>
                                            <img src="imagens/relatorio.png" width="20" height="20"><a href="GerenciarObjetosPerdidos?acao=listarTodos"> GERAR RELATÓRIO</a>
                                        </p>
                                    </div>
                                </td>
                            </tr>
