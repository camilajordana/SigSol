                                ...
                                <form method="post" action="GM"> 
                                    <div id="formm">
                                        <table width="100%" border="1" class="CSSTableGenerator">
                                            ...
                                            <c:forEach var="registroMateriais" items="${sessaoListaVideoAula}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ${registroMateriais['inicioVideoAula']}
                                                    </td>
                                                    <td>
                                                        ${registroMateriais['terminoVideoAula']}
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td width="3%">
                                                        ...
                                                        <input type="hidden" name="id_solicitacaoVideoAula" value="${registroMateriais['id_solicitacaoVideoAula']}"> 

                                                        <a href="GM?acao=aceitarVideoAula&id_solicitacaoVideoAula=${registroMateriais['id_solicitacaoVideoAula']}"><img src="imagens/feito.png" width="20" height="20" alt="deletar"/></a></td>
                                                    <td width="3%">   <a href="GM?acao=naoaceitoVideoAula&id_solicitacaoVideoAula=${registroMateriais['id_solicitacaoVideoAula']}"><img src="imagens/naofeito.png" width="20" height="20" alt="deletar"/></a></td>
                            ...
                            <tr>
                                <td>
                                    <div align="right"> 
                                        <br>
                                        <p>
                                            <img src="imagens/relatorio.png" width="20" height="20"><a href="GerenciarMateriais?acao=listarTodosVideoAula"> GERAR RELATÓRIO</a>
                                        </p>
                                    </div>
                                </td>
                            </tr>
