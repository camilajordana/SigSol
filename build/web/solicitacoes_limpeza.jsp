                    ...
                    <table border="0" width="100%">
                        <tr>
                            <td  colspan="4" align="center">
                                <h2 id="a1">Solicitações de limpeza de sala</h2>
                            </td>
                                            ...
                                            <c:forEach var="registroLimpeza" items="${sessaoListaLimpeza}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="3%">
                                                        ...
                                                        <input type="hidden" name="id_solicitacaoLimpeza" value="${registroLimpeza['id_solicitacaoLimpeza']}"> 

                                                        <a href="GM?acao=aceitarLimpeza&id_solicitacaoLimpeza=${registroLimpeza['id_solicitacaoLimpeza']}"><img src="imagens/feito.png" width="20" height="20" alt="deletar"/></a></td>
                                                    <td width="3%">   <a href="GM?acao=naoaceitoLimpeza&id_solicitacaoLimpeza=${registroLimpeza['id_solicitacaoLimpeza']}"><img src="imagens/naofeito.png" width="20" height="20" alt="deletar"/></a></td>
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                ...
                                                <br>
                                                <p>
                                                    <img src="imagens/relatorio.png" width="20" height="20"><a href="GerenciarLimpeza?acao=listarTodos"> GERAR RELATÓRIO</a>
                                                </p>
                                                </div>
                                            </td>
                                        </tr>
