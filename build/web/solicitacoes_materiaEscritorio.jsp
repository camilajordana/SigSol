...
<html>
    ...
    <ul id="c">
                        ...
                        <li class="selected"><a href="#"><strong>Solicitações</strong></a>
                            <ul>
                    ...
                    <table border="0" width="100%">
                        <tr>
                            <td  colspan="4" align="center">
                                <h2 id="a1">Solicitações de material de escritório</h2>
                                <h3 id="a2">Avalie cada solicitação de materiais de escritório</h3>
                            </td>
                                            ...
                                            <c:forEach var="registroMateriais" items="${sessaoListaMateriais}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="3%">
                                                        ...
                                                        <input type="hidden" name="id_solicitacaoEscritorio" value="${registroMateriais['id_solicitacaoEscritorio']}"> 
                                                        <input type="hidden" name="idsolicitarescritorio" value="${registroMateriais['idsolicitarescritorio']}"> 

                                                        <a href="GM?acao=aceitar&id_solicitacaoEscritorio=${registroMateriais['id_solicitacaoEscritorio']}"><img src="imagens/feito.png" width="20" height="20" alt="deletar"/></a></td>
                                                    <td width="3%">   <a href="GM?acao=naoaceito&id_solicitacaoEscritorio=${registroMateriais['id_solicitacaoEscritorio']}"><img src="imagens/naofeito.png" width="20" height="20" alt="deletar"/></a></td>
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                ...
                                                <br>
                                                <p>
                                                    <img src="imagens/relatorio.png" width="20" height="20"><a href="GerenciarMateriais?acao=listarTodos"> GERAR RELATÓRIO</a>
                                                </p>
                                                </div>
                                            </td>
                                        </tr>
